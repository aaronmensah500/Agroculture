	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Culture Fam<span>Accra, Ghana</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">233 54 370 1415</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:aaronkwamemensah@gmail.com" style="color:white">aaronkwamemensah@gmail.com</a></p>
			</div>
		</div>
